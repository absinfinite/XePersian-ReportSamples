...
\section{بخش ۱}
%\cite{alvarez}
\subsection{الف : \lr {Normalization}}
 عملگر 
...
\end{enumerate}
%نحوه وارد کردن واژه‌نامه انگلیسی به فارسی. چنانچه تعداد واژه‌های شما زیاد است، برای راحتی کار باید از بسته glossaries استفاده کنید.
\section{واژه‌نامه}
...
آماده شده توسط وحید دامن‌افشان\LTRfootnote{http://www.damanafshan.ir}. برای دیدن نمونه مثال‌های بیشتر، می‌توانید به سایت پارسی‌لاتک\LTRfootnote{http://www.parsilatex.com}، قسمت «پرونده‌های نمونه زی‌پرشین» مراجعه کنید.
\end{document} 
